...
nondiscrimination_risk_set$Policy[is.na(curriculum_risk_set$Policy)] <- 0
nondiscrimination_risk_set$Category[is.na(curriculum_risk_set$Category)] <- "Nondiscrimination"
```
