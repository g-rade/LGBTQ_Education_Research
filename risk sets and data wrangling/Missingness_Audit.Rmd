...
state_data <- import("./datasets/complete_covars.csv") ## risk set we used for modeling
```
...
- std_init_use missing for many states from 2016-2023, need to look into that becuase I have the data through 2022 (why? must fix)
