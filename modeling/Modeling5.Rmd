...
ggplot(secondary_total_full, aes(x = evangelical_pop, y = pred_prob, color = lawrence)) + geom_smooth(method = "lm") +
  labs(y = "Predicted Probability of Adoption", x = "Evangelical Population", color = "Lawrence v. Texas", title = "Predicted Probability of Total Adoption by Evangelical Population and Lawrece v. Texas")
