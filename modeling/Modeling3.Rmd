...
```{r}
stargazer(primary_model, simplest_model, positive_primary, negative_primary, type = "html", out = "primary_models2.html", column.labels = c("Full Primary ", "Reduced Primary ", "Positive Primary ", "Negative Primary "), covariate.labels = c("Lawrence", "Obergefell", "Neighbor Adoptions", " Population","Policy Liberalisl","Per Capita Income", "Legislative Professionalism 1",
